...
// Verify plugin-manifest includes a runtime entry for @renderx/canvas-component
// Path is relative to this package test to the repo public/ directory

describe("plugin-manifest runtime entry: @renderx/canvas-component", () => {
  it("includes a runtime entry for @renderx/canvas-component", async () => {
    ...
    expect(entry.runtime?.module).toBe("@renderx/canvas-component");
