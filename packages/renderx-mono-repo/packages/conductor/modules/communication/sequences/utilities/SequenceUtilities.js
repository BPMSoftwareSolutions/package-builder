...
export class SequenceUtilities {
    static SEQUENCE_ID_PREFIX = "seq";
    static INSTANCE_ID_PREFIX = "inst";
    /**
    ...
    createExecutionContext(sequenceRequest) {
        ...
        return {
            ...
            sequence: {}, // Will be filled in by the caller
...
//# sourceMappingURL=SequenceUtilities.js.map