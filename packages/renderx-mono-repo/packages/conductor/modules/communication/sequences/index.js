 ...
 */
export function registerAllSequences(conductor) {
 ...
 */
export function getSequenceByName(sequenceName) {
 ...
 */
export function getSequencesByCategory(category) {
 ...
 */
export function initializeMusicalSequences(conductor) {
