...
export class SPAValidator {
    violations = [];
    config;
    originalEventBusEmit = null;
    originalEventBusSubscribe = null;
    ...
    createValidatedEmit() {
        return function (eventName, data, options = {}) {
            ...
            if (eventName === "stage:cue" &&
                data && data.meta && data.meta.__stageCrewInternal) {
                return validator.originalEventBusEmit.call(this, eventName, data, options);
            }
    ...
    analyzeCallStack(stack) {
        ...
        for (const line of lines) {
            ...
            if (normalized.includes("/node_modules/musical-conductor/") ||
            ...
            if (normalized.includes("MusicalConductor") ||
...
//# sourceMappingURL=SPAValidator.js.map