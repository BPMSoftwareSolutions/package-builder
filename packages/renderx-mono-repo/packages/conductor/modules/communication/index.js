 ...
 */
// EventBus exports
export { EventBus, ConductorEventBus, eventBus, } from "./EventBus.js";
// Event Types exports
export { EVENT_TYPES, EVENT_CATEGORIES, CORE_EVENT_TYPES, getEventCategory, getEventsByCategory, } from "./event-types/index.js";
...
import { eventBus as internalEventBus } from "./EventBus.js";
// Musical Sequences exports
export { MusicalSequences, ALL_SEQUENCES, SEQUENCE_NAMES, registerAllSequences, initializeMusicalSequences, getSequenceByName, getSequencesByCategory, validateAllSequences, } from "./sequences/index.js";
// Sequence Types exports
export { MUSICAL_DYNAMICS, MUSICAL_TIMING, SEQUENCE_CATEGORIES, MUSICAL_CONDUCTOR_EVENT_TYPES, MUSICAL_SEQUENCE_TEMPLATE, SEQUENCE_PRIORITIES, } from "./sequences/SequenceTypes.js";
 ...
 */
export function resetCommunicationSystem() {
...
export function initializeCommunicationSystem() {
    ...
    internalEventBus.connectToMainConductor(conductor);
...
export function getCommunicationSystemStatus() {
    ...
    return {
        eventBus: {
            ...
            metrics: internalEventBus.getMetrics(),
        },
        conductor: {
