...
interface CIAGateStatusProps {
  metrics: CIAGateMetrics;
  onDrillDown?: () => void;
}

export const CIAGateStatus: React.FC<CIAGateStatusProps> = ({ metrics, onDrillDown }) => {
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
        <h3 style={{ margin: 0, color: 'var(--text-primary)' }}>CIA Gate Status</h3>
